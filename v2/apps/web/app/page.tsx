...
const Page = () => {
  ...
  const sources = useAtomValue(
    isClient ? sourcesByWorkspace(workspaceId) : sourcesLoading,
  );
  const refreshSources = useAtomRefresh(
    isClient ? sourcesResultByWorkspace(workspaceId) : sourcesResultDisabled,
  );
      ...
      <section className="shell">
        ...
        <div className="grid">
          ...
          <section className="card">
            ...
            {sources.state === "refreshing" ? (
              <p className="status">Refreshing sources...</p>
            ) : null}

...
you have repos in .reference like effect, effect-atom. if you are given a git url clone it into that directory to explore it. if you need to know about good patterns look in there

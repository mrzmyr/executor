      ...
      <div className="flex h-full min-h-0 flex-col">
        ...
        <div className="shrink-0 border-b border-border/30 bg-muted/20 p-3">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-1.5">
            ...
            <Button variant="ghost" size="sm" className="h-6 rounded-md px-2 text-[10px] text-muted-foreground" onClick={onRunUserTables}>
              User tables
            </Button>
            <Button variant="ghost" size="sm" className="h-6 rounded-md px-2 text-[10px] text-muted-foreground" onClick={onRunAllObjects}>
              All objects
            </Button>
            <Button variant="ghost" size="sm" className="h-6 rounded-md px-2 text-[10px] text-muted-foreground" onClick={onRunKvSchema}>
              KV schema
            </Button>
            <Button variant="ghost" size="sm" className="h-6 rounded-md px-2 text-[10px] text-muted-foreground" onClick={onRunKvData}>
              KV data
            </Button>
            <Button variant="ghost" size="sm" className="h-6 rounded-md px-2 text-[10px] text-muted-foreground" onClick={onRunFsEntries}>
              FS entries
            </Button>

...
const toDescriptor = (
  ...
  previewInputType: includeSchemas && artifact.inputSchema ? "object" : undefined,
  previewOutputType: includeSchemas && artifact.outputSchema ? "output" : undefined,
          ...
          results: [
            {
              ...
              interaction: "auto",
              previewInputType: "{ owner: string, repo: string }",
              previewOutputType: "void",
            },
          ],
          total: 1,
        },

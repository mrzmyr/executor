...
- keep connection state, secret material, execution, and inspection in one local control plane
...
4. resolves secret material and policy at invocation time
...
- secret material and private auth state
- persistence
